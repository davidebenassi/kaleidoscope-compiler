...
kcomp.o:  kcomp.cpp driver.hpp
	clang++-17 -c kcomp.cpp -I /usr/lib/llvm-17/include -std=c++17 -fno-exceptions -D_GNU_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS
