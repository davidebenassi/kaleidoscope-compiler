...
#line 888 "parser.cpp"
  ...
  case 16: // stmt: block
#line 127 "parser.yy"
                             { yylhs.value.as < ExprAST* > () = yystack_[0].value.as < std::<vector>ExprAST* > (); }
#line 894 "parser.cpp"
    break;
...
#line 906 "parser.cpp"
  ...
  case 19: // block: "{" stmts "}"
#line 134 "parser.yy"
                              { yylhs.value.as < std::<vector>ExprAST* > () = yystack_[1].value.as < std::vector<ExprAST*> > (); }
#line 912 "parser.cpp"
    break;

  case 20: // block: "{" vardefs ";" stmts "}"
#line 135 "parser.yy"
                              { yylhs.value.as < std::<vector>ExprAST* > () = new BlockExprAST(yystack_[3].value.as < std::vector<VarBindingAST*> > (),yystack_[1].value.as < std::vector<ExprAST*> > ()); }
#line 918 "parser.cpp"
    break;
...
#line 980 "parser.cpp"
  ...
  case 31: // vardefs: vardefs ";" binding
#line 152 "parser.yy"
...
#undef YYCASE_
  ...
  parser::yypact_[] =
  {
      -1,   -12,   -12,    11,   -31,    10,   -31,   -31,    13,   -31,
      25,   -31,    -1,     3,    25,    -6,    14,   -31,   -31,    87,
     -31,    24,   -31,   -31,     3,    15,    67,    18,    -3,    23,
      40,   -31,     2,    87,    41,   -31,    25,    25,    25,    25,
      25,    25,    25,    25,   -31,   -31,   -31,    30,    25,   -31,
      33,    -6,    57,    38,   -31,     0,     0,   -31,   -31,    87,
      87,    77,    25,   -31,    87,   -31,    34,   -31,    25,   -31,
      25,    87,   -31,   -31,    87
  };
  ...
  {
       3,     0,     0,     0,     2,     0,     6,     7,     0,     9,
       0,     1,     3,    11,     0,     0,    38,    27,    29,     8,
      28,     0,    25,     4,    11,     0,     0,     0,    38,     0,
      13,    15,    29,    17,     0,    30,    40,     0,     0,     0,
       0,     0,     0,     0,    12,    10,    26,    33,     0,    19,
       0,     0,    42,     0,    41,    22,    21,    23,    24,    36,
      37,     0,     0,    32,    18,    14,     0,    31,     0,    39,
       0,    34,    20,    43,    35
  };
  ...
  parser::yypgoto_[] =
  {
     -31,   -31,    44,   -31,   -31,   -31,    48,    29,   -30,   -31,
     -31,   -14,   -10,   -31,     6,   -31,   -31,   -31,   -31,   -31,
      -9
  };
  ...
  parser::yydefgoto_[] =
  {
       0,     3,     4,     5,     6,     7,     9,    25,    29,    30,
      31,    18,    33,    34,    35,    63,    20,    21,    22,    53,
      54
  };
  ...
  parser::yytable_[] =
  {
      19,    32,    -5,    14,    26,   -16,    36,    39,    40,     8,
      15,    11,    48,    12,    27,    28,    17,     1,     2,   -16,
      65,    66,    13,    36,    24,    45,    52,    55,    56,    57,
      58,    59,    60,    61,    14,    43,    32,    32,    64,    47,
      49,    15,    14,    50,    51,    62,    16,    17,    69,    15,
      10,    72,    71,    44,    28,    17,    23,    67,    52,    73,
      74,    68,    37,    38,    39,    40,     0,     0,     0,     0,
      41,    42,    37,    38,    39,    40,     0,    46,     0,     0,
      41,    42,    37,    38,    39,    40,     0,     0,     0,    70,
  ...
  parser::yycheck_[] =
  {
      10,    15,     3,     9,    14,     3,     9,     7,     8,    21,
      16,     0,    15,     3,    20,    21,    22,    18,    19,    17,
      50,    51,     9,     9,    21,    10,    36,    37,    38,    39,
      40,    41,    42,    43,     9,    11,    50,    51,    48,    21,
      17,    16,     9,     3,     3,    15,    21,    22,    10,    16,
       2,    17,    62,    24,    21,    22,    12,    51,    68,    68,
      70,     4,     5,     6,     7,     8,    -1,    -1,    -1,    -1,
      13,    14,     5,     6,     7,     8,    -1,    10,    -1,    -1,
      13,    14,     5,     6,     7,     8,    -1,    -1,    -1,    12,
      13,    14,     5,     6,     7,     8,    -1,    -1,    -1,    -1,
      13,    14
  };
  ...
  parser::yystos_[] =
  {
      ...
      29,     0,     3,     9,     9,    16,    21,    22,    34,    35,
      39,    40,    41,    25,    21,    30,    35,    20,    21,    31,
      32,    33,    34,    35,    36,    37,     9,     5,     6,     7,
       8,    13,    14,    11,    30,    10,    10,    21,    15,    17,
       3,     3,    35,    42,    43,    35,    35,    35,    35,    35,
      35,    35,    15,    38,    35,    31,    31,    37,     4,    10,
      12,    35,    17,    43,    35
  };
  ...
  "assignment", "block", "exp", "vardefs", "binding", "initexp", "expif",
  "condexp", "idexp", "optexp", "explist", YY_NULLPTR
  };
#endif
  ...
  parser::yyrline_[] =
  {
     ...
     105,   109,   111,   119,   123,   126,   127,   128,   131,   134,
     135,   138,   139,   140,   141,   142,   143,   144,   145,   146,
     149,   152,   156,   159,   160,   163,   166,   167,   170,   171,
     174,   176,   179,   183
  };
